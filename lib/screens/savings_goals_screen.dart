                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: isSel ? c : Colors.transparent,
                                width: 1.5,
                              ),
                            ),
                            child: Icon(
                              e.value,
                              color: isSel ? c : const Color(0xFF9E9E9E),
                              size: 22,
                            ),
                          ),
                        ),
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final amt = double.tryParse(
                        stripCommas(amountCtl.text.trim()),
                      );
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'Remaining: LKR ${formatCurrency(goal.remaining)}',
              style: GoogleFonts.poppins(
                color: const Color(0xFF9E9E9E),
                fontSize: 13,
              ),
            ...
            onPressed: () async {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      'LKR ${formatCurrency(amt)} added & recorded as expense',
                      style: GoogleFonts.poppins(),
                    ),
                    backgroundColor: const Color(0xFF00C9A7),
                  ),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              Navigator.pop(ctx);
              await _fs.deleteSavingsGoal(userId, goalId);
            },
            child: Text(
              'Delete',
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'LKR ${formatCurrencyWhole(totalSaved)}',
                                style: GoogleFonts.poppins(
                              ...
                              Text(
                                'of LKR ${formatCurrencyWhole(totalTarget)}',
                                style: GoogleFonts.poppins(
                                  color: const Color(0xFF9E9E9E),
                                  fontSize: 12,
                                ),
                ...
                return Padding(
                  ...
                  child: Dismissible(
                    ...
                    confirmDismiss: (_) async {
                      if (goal.id != null) _deleteGoal(userId, goal.id!);
                      return false;
                    },
                    child: GestureDetector(
                          ...
                          children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'LKR ${formatCurrency(goal.savedAmount)} / ${formatCurrency(goal.targetAmount)}',
                                        style: GoogleFonts.poppins(
                                          color: const Color(0xFF9E9E9E),
                                          fontSize: 12,
                                        ),
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    'LKR ${formatCurrency(goal.remaining)} remaining',
                                    style: GoogleFonts.poppins(
                                      color: const Color(0xFF9E9E9E),
                                      fontSize: 11,
                                    ),
                                ...
                                if (!goal.isCompleted)
                                  GestureDetector(
                                    onTap: () =>
                                        _showAddMoneyDialog(userId, goal),
                                    child: Container(
                                      padding: const EdgeInsets.symmetric(
                                        horizontal: 12,
                                        vertical: 6,
